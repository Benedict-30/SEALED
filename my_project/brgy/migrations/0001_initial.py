# Generated by Django 6.0.6 on 2026-06-08 14:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('officials', models.JSONField(blank=True, default=dict)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('role', models.CharField(choices=[('resident', 'Resident'), ('staff', 'Staff'), ('admin', 'Administrator')], default='resident', max_length=20)),
                ...
                ('barangay', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='users', to='brgy.barangay')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('barangay', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='document_types', to='brgy.barangay')),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pending'), ('approved', 'Approved'), ('ready_for_pickup', 'Ready for Pickup'), ('completed', 'Completed'), ('rejected', 'Rejected')], default='pending', max_length=20)),
                ...
                ('document_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='requests', to='brgy.documenttype')),
            ],
            options={
                'ordering': ['-created_at'],
            },
