...
urlpatterns = [
    ...
    path('notifications/toggle/<uuid:pk>/', views.set_notification_read, name='set_notification_read'),
    path('notifications/delete/<uuid:pk>/', views.delete_notification, name='delete_notification'),
    ...
    path('staff/document-types/<uuid:pk>/toggle/', views.staff_toggle_document_type, name='staff_toggle_document_type'),
